...
---@type AssignSequence
b.g3 = {type = "sequence", 50, {"c", condition = keydown("-")}, loop = -1, play = "toggle"}
...
---@type AssignSequence|[number, [AssignKey,AssignFlag]]
b.g4 = { type = "sequence",50,{
      {"d", condition = {'*d_p', keydown("-"), logic = "and"}},
      {type = "flag", "d_p", toggle = true, condition = {".d_p", keydown("-"), logic = "xor"}}
   },loop = -1,play = "toggle"}